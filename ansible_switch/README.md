...
- In case a real hardware device gets plugged in to the main computer's network, it will be detected then displayed on **DISCOVERED** connections within section **[6]**.
- Any dummy IPs can be used as placeholder values to be replaced by those of the actual physical devices. You are then allowed to freely interact with and edit them. 
